                ...
                <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="d-flex flex-column py-5 mx-auto" style="width: 30rem">
                        <div class="mb-3">
                            ...
                            <a href="<?php BASE_URL ?> admin" style="font-family: var(--title-font)">CHECK LIST PENDAFTARAN</a>
                        </div>
                        <form action="<?= BASE_URL; ?>/user/insertUser" method="POST" enctype="multipart/form-data">
                            <div class="mb-2">
